...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Bültene abone ol', description: 'E-posta DB\'ye kaydedilir ve Brevo Contact List\'e asenkron eklenir.' }),
    (0, swagger_1.ApiResponse)({ status: 201, schema: { example: { message: 'Bültene başarıyla kaydoldunuz' } } }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Bu e-posta zaten kayıtlı' }),
